...
import { CatalogModel, findCategoryBySlugForCatalog, getActiveBrandIds, checkBrandInCategories, checkModelDependencies, findModelByFilter, findModelBySlug } from '../../../services/catalog/CatalogBrandModelService';
...
import { modelCreateSchema, modelUpdateSchema, rejectionSchema } from '../../../validators/catalog.validator';
