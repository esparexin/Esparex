...
import { getHierarchyTree as buildHierarchyTree, scanHierarchyIntegrity, repairHierarchy } from '@core/services/catalog/CatalogHierarchyService';
import { sendSuccessResponse } from "@core/utils/respond";
import { sendCatalogError, hasAdminAccess } from './shared';
import { findCategoryByIdLean, getCategoryHealthMetrics } from '@core/services/catalog/CatalogGovernanceService';
...
import { IAuthUser as AuthUser } from '@core/types/auth';
