...
exports.aiGenerateSchema = void 0;
const zod_1 = require("zod");
const nonEmptyString = zod_1.z.preprocess((value) => (typeof value === 'string' ? value.trim() : value), zod_1.z.string().min(1));
exports.aiGenerateSchema = zod_1.z
    .object({
    type: zod_1.z.enum(['identify', 'generate', 'moderate']),
    context: zod_1.z
        .object({
        ...
        spareParts: zod_1.z.union([nonEmptyString, zod_1.z.array(nonEmptyString)]).optional(),
    })
        .passthrough()
        .optional(),
    image: nonEmptyString.optional(),
