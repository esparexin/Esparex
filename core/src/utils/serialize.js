...
exports.serializeDocs = serializeDocs;
exports.serializePaginated = serializePaginated;
const isObjectRecord = (value) => (typeof value === 'object' && value !== null && !Array.isArray(value));
const isObjectIdLike = (value) => (isObjectRecord(value)
...
function serializeDoc(doc) {
    ...
    const docWithObject = doc;
    const obj = (typeof docWithObject.toObject === 'function')
 ...
 */
function serializePaginated(data) {
    if (!data || !data.docs)
        return data;
    return {
        ...data,
