 ...
 */
function logExternalAPI(service, endpoint, durationMs, success, error) {
    // 📊 RECORD PROMETHEUS METRIC
    Promise.resolve().then(() => __importStar(require('@core/utils/metrics'))).then(({ externalApiDuration: prometheusMetric }) => {
