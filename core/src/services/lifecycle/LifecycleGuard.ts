...
export const ALLOWED_AD_TRANSITIONS: Record<string, string[]> = {
    ...
    // SOLD → DELETED is intentional: users must be able to remove sold listings from their history.
...
export const ALLOWED_SERVICE_TRANSITIONS: Record<string, string[]> = {
    ...
    // SOLD → DELETED is intentional: users must be able to remove sold service listings from their history.
    [LIFECYCLE_STATUS.SOLD]: [LIFECYCLE_STATUS.DEACTIVATED, LIFECYCLE_STATUS.DELETED],
...
export const ALLOWED_SPARE_PART_LISTING_TRANSITIONS: Record<string, string[]> = {
    ...
    [LIFECYCLE_STATUS.EXPIRED]: [LIFECYCLE_STATUS.PENDING, LIFECYCLE_STATUS.LIVE],
    [LIFECYCLE_STATUS.DEACTIVATED]: [LIFECYCLE_STATUS.LIVE],
    // SOLD → DELETED is intentional: users must be able to remove sold spare-part listings from their history.
