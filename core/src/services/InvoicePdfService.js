...
const buildMinimalPdfBuffer = (lines) => {
    const contentLines = [
        'BT',
        '/F1 12 Tf',
        '50 780 Td',
...
const generateInvoicePdf = async (invoice) => {
    try {
        ...
        return await (0, s3_1.uploadToS3)(pdfBuffer, key, 'application/pdf');
    }
    catch (error) {
        logger_1.default.warn('Invoice PDF generation/upload skipped', {
