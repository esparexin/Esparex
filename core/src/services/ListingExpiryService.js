...
class ListingExpiryService {
    static async runSweep(now = new Date()) {
        ...
        const expiredCount = await (0, StatusMutationService_1.mutateStatusesBulk)('ad', listingIds, adStatus_1.AD_STATUS.EXPIRED, { type: actor_1.ACTOR_TYPE.SYSTEM, id: 'listing_expiry_cron' }, 'Automated expiry');
