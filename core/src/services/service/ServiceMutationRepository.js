...
const updateServiceByOwner = async (id, userId, businessId, listingType, updates) => Ad_1.default.findOneAndUpdate({ _id: id, listingType: listingType, businessId: (businessId || { $exists: false }), sellerId: userId }, updates, { new: true });
