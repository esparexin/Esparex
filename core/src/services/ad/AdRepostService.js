...
const repostAdLogic = async (id, userId) => {
    ...
    try {
        await session.withTransaction(async () => {
            ...
            const isExpired = currentStatus === listingStatus_1.LISTING_STATUS.EXPIRED;
            const isRejected = currentStatus === listingStatus_1.LISTING_STATUS.REJECTED;
            ...
            const nextStatus = listingStatus_1.LISTING_STATUS.PENDING;
            const now = new Date();
