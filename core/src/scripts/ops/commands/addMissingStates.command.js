...
exports.addMissingStatesCommand = void 0;
const commandUtils_1 = require("./commandUtils");
/**
 * 🗺️ Add Missing Indian States/UTs
 */
exports.addMissingStatesCommand = {
    ...
    run: async (context) => {
        ...
        for (const stateData of missingStates) {
            ...
            if (isApply) {
                let lat = 0, lng = 0;
                if (stateData.name === 'Assam') {
                    lat = 26.2006;
                    lng = 92.9376;
                }
                if (stateData.name === 'Chandigarh') {
                    lat = 30.7333;
                    lng = 76.7794;
                }
                if (stateData.name === 'Puducherry') {
                    lat = 11.9416;
                    lng = 79.8083;
                }
...
//# sourceMappingURL=addMissingStates.command.js.map