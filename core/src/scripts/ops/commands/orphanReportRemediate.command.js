...
exports.orphanReportRemediateCommand = void 0;
const mongoose_1 = __importDefault(require("mongoose"));
const commandUtils_1 = require("./commandUtils");
const ACTIVE_STATUSES = ['open', 'pending', 'reviewed'];
const BATCH_SIZE = 300;
exports.orphanReportRemediateCommand = {
        ...
        try {
            ...
            const flush = async () => {
                ...
                if (dismissIds.length > 0) {
                    const result = await reports.updateMany({ _id: { $in: dismissIds }, status: { $in: ACTIVE_STATUSES } }, {
                        $set: {
                            status: 'dismissed',
            ...
            const cursor = reports.find({ targetType: 'ad' }, { projection: { _id: 1, status: 1, targetType: 1, targetId: 1, adId: 1 } });
...
//# sourceMappingURL=orphanReportRemediate.command.js.map