...
exports.reportUnifyBackfillCommand = void 0;
...
const isValidObjectIdLike = (value) => value !== undefined &&
    value !== null &&
    mongoose_1.default.Types.ObjectId.isValid(String(value));
const countMissingField = async (collection, field) => collection.countDocuments({
    $or: [{ [field]: { $exists: false } }, { [field]: null }, { [field]: '' }],
});
exports.reportUnifyBackfillCommand = {
...
//# sourceMappingURL=reportUnifyBackfill.command.js.map