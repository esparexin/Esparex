...
**Generated At:** 2026-07-25T13:45:35.597Z  
...
| **Transitional Modules** | 151 | In `core/src/services` |
| — *Pure Re-export Shims* | 74 | Forwarders to `core/src/domains` |
| — *Facades & Wrappers* | 2 | Compatibility wrappers |
| — *Unmigrated Services* | 75 | Pending DDD domain encapsulation |
| **Empty Directories** | 3 | E.g. `docs/audits/P2.2` |
| **Orphaned Directories** | 0 | `tools/templates/domain-package` |
| **JSCPD Code Clones** | 32 | Detected code duplications |
...
### Clone #6 (20 lines, 0 tokens)
- **Source A:** `[object Object]` (Lundefined-Lundefined)
- **Source B:** `[object Object]` (Lundefined-Lundefined)

### Clone #7 (13 lines, 0 tokens)
- **Source A:** `[object Object]` (Lundefined-Lundefined)
- **Source B:** `[object Object]` (Lundefined-Lundefined)

### Clone #8 (33 lines, 0 tokens)
- **Source A:** `[object Object]` (Lundefined-Lundefined)
- **Source B:** `[object Object]` (Lundefined-Lundefined)

### Clone #9 (45 lines, 0 tokens)
- **Source A:** `[object Object]` (Lundefined-Lundefined)
- **Source B:** `[object Object]` (Lundefined-Lundefined)

### Clone #10 (37 lines, 0 tokens)
- **Source A:** `[object Object]` (Lundefined-Lundefined)
- **Source B:** `[object Object]` (Lundefined-Lundefined)
