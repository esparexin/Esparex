...
export const ADMIN_ROUTES = {
  ...
  CATALOG_HIERARCHY_TREE: "/catalog/governance/hierarchy-tree",
  CATALOG_GOVERNANCE_METRICS: "/catalog/governance/metrics",
  CATALOG_GOVERNANCE_LOGS: "/catalog/governance/logs",
  AI_ANALYSIS_QUEUE: "/catalog/ai-analysis",
