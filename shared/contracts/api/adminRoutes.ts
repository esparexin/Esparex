...
export const ADMIN_ROUTES = {
  ...
  CODE_HEALTH_SUMMARY: "/code-health",
  CODE_HEALTH: "/code-health/report",
  CODE_HEALTH_SCAN: "/code-health/scan",
  CODE_HEALTH_REPORT: "/code-health/report",
  CODE_HEALTH_APPROVE: "/code-health/approve",
  CODE_HEALTH_REMOVE: "/code-health/remove",
  CODE_HEALTH_HISTORY: "/code-health/history",
  CODE_HEALTH_WHITELIST: "/code-health/whitelist",
  CODE_HEALTH_WHITELIST_BY_ID: (id: string) => `/code-health/whitelist/${id}`,
  SETTINGS: "/settings",
