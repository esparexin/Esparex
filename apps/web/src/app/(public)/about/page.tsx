        ...
        <InfoPage title="About Esparex">
            <div className="space-y-6 not-prose">
                <section>
                    ...
                    <p className="text-body text-foreground-secondary leading-relaxed mb-3">
                ...
                <section>
                    <h2 className="text-h3 font-bold text-foreground mb-4">Why the Community Chooses Esparex</h2>
                    <div className="space-y-3">
                        <div className="flex items-start gap-3.5 p-4 rounded-xl bg-muted/40 border border-border">
                            <div className="h-9 w-9 shrink-0 rounded-full bg-primary/10 flex items-center justify-center">
                                <span className="text-primary font-bold text-body">1</span>
                            </div>
                            <div>
                                <h4 className="text-body font-bold text-foreground">Verified B2B Storefronts</h4>
                                <p className="text-caption text-foreground-secondary leading-relaxed mt-1">We actively vet our business partners. Sellers with the &quot;Verified Business&quot; badge have submitted legitimate KYC, GST, or Shop Establishment Act documents, ensuring you receive authentic parts.</p>
                            </div>
                        </div>
                        <div className="flex items-start gap-3.5 p-4 rounded-xl bg-muted/40 border border-border">
                            <div className="h-9 w-9 shrink-0 rounded-full bg-primary/10 flex items-center justify-center">
                                <span className="text-primary font-bold text-body">2</span>
                            </div>
                            <div>
                                <h4 className="text-body font-bold text-foreground">A Comprehensive Catalog</h4>
                                <p className="text-caption text-foreground-secondary leading-relaxed mt-1">From rare IC chips and flex cables to fully refurbished iPhones and MacBooks, our strictly moderated catalog ensures finding exactly what you need without sifting through spam.</p>
                            </div>
                        </div>
                        <div className="flex items-start gap-3.5 p-4 rounded-xl bg-muted/40 border border-border">
                            <div className="h-9 w-9 shrink-0 rounded-full bg-primary/10 flex items-center justify-center">
                                <span className="text-primary font-bold text-body">3</span>
                            </div>
                            <div>
                                <h4 className="text-body font-bold text-foreground">Hyper-Local Services</h4>
                                <p className="text-caption text-foreground-secondary leading-relaxed mt-1">Don&apos;t want to repair it yourself? Use our Services portal to find highly-rated, local technicians who offer on-site repairs or shop walk-ins with transparent pricing.</p>
                            </div>
                        </div>
                        <div className="flex items-start gap-3.5 p-4 rounded-xl bg-muted/40 border border-border">
                            <div className="h-9 w-9 shrink-0 rounded-full bg-primary/10 flex items-center justify-center">
                                <span className="text-primary font-bold text-body">4</span>
                            </div>
                            <div>
                                <h4 className="text-body font-bold text-foreground">Direct & Transparent</h4>
                                <p className="text-caption text-foreground-secondary leading-relaxed mt-1">We believe in zero hidden commission fees between buyers and sellers. Our realtime chat enables direct negotiation, location sharing, and trust-building before any money changes hands.</p>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section className="pt-2">
                    <p className="text-caption text-foreground-subtle italic text-center">
