    ...
    return (
        <InfoPage title="Privacy Policy" lastUpdated={LEGAL_LAST_UPDATED}>
            <div className="space-y-6 text-foreground-secondary text-body leading-relaxed">
                ...
                <section>
                    <h2 className="text-h3 font-bold text-foreground mb-2">1. Information We Collect</h2>
                    <p className="mb-2">
                ...
                <section>
                    <h2 className="text-h3 font-bold text-foreground mb-2">2. How We Use Information</h2>
                    <p className="mb-2">
                ...
                <section>
                    <h2 className="text-h3 font-bold text-foreground mb-2">3. Data Sharing & Third Parties</h2>
                    <p className="mb-2">
                ...
                <section>
                    <h2 className="text-h3 font-bold text-foreground mb-2">4. Content Moderation & Security</h2>
                    <p>
                ...
                <section>
                    <h2 className="text-h3 font-bold text-foreground mb-2">5. Data Deletion & Your Rights</h2>
                    <p>
