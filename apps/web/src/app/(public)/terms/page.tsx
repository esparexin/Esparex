...
export default function TermsPage() {
    return (
        <InfoPage title="Terms of Service" lastUpdated={LEGAL_LAST_UPDATED}>
            <div className="space-y-6 text-foreground-secondary text-body leading-relaxed">
                <section>
                    <p>
                ...
                <section>
                    <h2 className="text-h3 font-bold text-foreground mb-2">1. Platform Nature</h2>
                    <p>
                ...
                <section>
                    <h2 className="text-h3 font-bold text-foreground mb-2">2. User Accounts & Verification</h2>
                    <p className="mb-2">
                ...
                <section>
                    <h2 className="text-h3 font-bold text-foreground mb-2">3. Prohibited Content and Goods</h2>
                    <p className="mb-2">
                ...
                <section>
                    <h2 className="text-h3 font-bold text-foreground mb-2">4. Payments & Subscriptions</h2>
                    <p>
                ...
                <section>
                    <h2 className="text-h3 font-bold text-foreground mb-2">5. Disclaimer of Warranties & Limitation of Liability</h2>
                    <p>
