...
export default function robots(): MetadataRoute.Robots {
    return {
        rules: [
            // 1. Default search engines crawl policies
            {
                userAgent: '*',
                allow: '/',
                disallow: [
            ...
            // 2. Defend against non-revenue scrapers and aggressive bots
            {
                userAgent: [
                    'Amazonbot',
                    'Amzn-SearchBot',
            ...
            // 3. Explicitly allow Google AdSense and AdWords monetization crawlers
            {
                userAgent: [
