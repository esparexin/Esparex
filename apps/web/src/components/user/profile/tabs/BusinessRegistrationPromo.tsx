  ...
  return (
    <div className="w-full space-y-4">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <h3 className="text-body-lg font-semibold text-foreground tracking-tight">Register your business</h3>
      ...
      {/* Highlights List */}
      <ul className="space-y-2.5 text-body text-foreground-secondary pt-1">
      ...
      <Button
        onClick={onRegister}
        className="w-full h-11 bg-primary hover:bg-primary/90 text-primary-foreground font-semibold text-body rounded-xl transition-all shadow-md active:scale-[0.98] mt-2"
      >
