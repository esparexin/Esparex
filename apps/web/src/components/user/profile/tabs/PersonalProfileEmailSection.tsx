    ...
    return (
        <div className="flex flex-col gap-1.5 scroll-mt-[calc(6rem+env(safe-area-inset-top,0px))]">
            ...
            <Input
                ...
                {...register("email")}
                className={`h-11 rounded-xl bg-card border-border px-3.5 text-body font-normal text-foreground placeholder:text-small placeholder:text-foreground-subtle scroll-mt-[calc(7.5rem+env(safe-area-inset-top,0px))] ${emailError ? "border-destructive" : ""}`}
