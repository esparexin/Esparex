          ...
          <div className="space-y-2 text-left">
            ...
            <FieldControl animateOnError>
              <div className="flex items-center gap-2">
                <div
                  aria-hidden="true"
                  className="flex items-center justify-center h-14 w-16 rounded-xl border border-border/80 bg-muted/40 text-foreground font-bold text-body-lg shrink-0 select-none shadow-xs"
                >
                  +91
                </div>
                <Input
                  ...
                  maxLength={10}
                  className={cn(
                    "h-14 px-4 text-body-lg sm:text-h4 tracking-wider font-semibold text-foreground bg-background border-border/80 rounded-xl focus-visible:border-emerald-600 focus-visible:ring-4 focus-visible:ring-emerald-600/15 transition-all shadow-xs flex-1 min-w-0",
