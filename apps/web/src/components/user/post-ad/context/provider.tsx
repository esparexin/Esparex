...
export function PostAdProvider({
    ...
    const { generateDescription, isGeneratingAI, isAiAvailable } = usePostAdAiGeneration(form as any, categoryMap, availableSpareParts, setFormError);
    ...
    const flowState = useMemo<PostAdFlowState>(() => ({ currentStep, stepValidationAttempts, isLoading, isGeneratingAI, isAiAvailable, isSubmitting, isEditMode, userHasInteracted, loadError, formError, submittedAd, form, control, errors, mode, listingId }), [currentStep, stepValidationAttempts, isLoading, isGeneratingAI, isAiAvailable, isSubmitting, isEditMode, userHasInteracted, loadError, formError, submittedAd, form, control, errors, mode, listingId]);
