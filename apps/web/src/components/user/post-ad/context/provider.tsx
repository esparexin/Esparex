...
export function PostAdProvider({
    ...
    const actionValue = useMemo<PostAdActionContextType>(() => ({ setCurrentStep, nextStep, prevStep, handleCategoryChange, handleBrandChange, handleModelChange, toggleSparePart, toggleAllSpareParts, addImages: imagesHook.addImages, removeImage: imagesHook.removeImage, setMainImage: imagesHook.setMainImage, reorderImages: imagesHook.reorderImages, setLocation, loadBrandsForCategory, loadModelsForBrand, loadSparePartsForCategory, loadCategorySchema, refreshBrands, generateDescription, submitAd, setUserHasInteracted, setLoadError, setFormError, setImageUploadError: imagesHook.setImageUploadError, setSubmittedAd, setValue, register, watch, initializeFromListing, resetToCreateMode }), [setCurrentStep, nextStep, prevStep, handleCategoryChange, handleBrandChange, handleModelChange, toggleSparePart, toggleAllSpareParts, imagesHook.addImages, imagesHook.removeImage, imagesHook.setMainImage, imagesHook.reorderImages, setLocation, loadBrandsForCategory, loadModelsForBrand, loadSparePartsForCategory, loadCategorySchema, refreshBrands, generateDescription, submitAd, setUserHasInteracted, setLoadError, setFormError, imagesHook.setImageUploadError, setSubmittedAd, setValue, register, watch, initializeFromListing, resetToCreateMode]);
