...
export function PostAdProvider({
    ...
    const { submitAd, isSubmitting, isInternalUploading } = usePostAdSubmissionFlow({ form: form as any, listingImages, setListingImages, isEditMode, editAdId, isLocationLocked, setFormError, setSubmittedAd });
    const { addImages, removeImage, setMainImage } = imagesHook;
    ...
    const actionValue = useMemo<PostAdActionContextType>(() => ({ setCurrentStep, nextStep, prevStep, handleCategoryChange, handleBrandChange, createAndSelectBrand, createAndSelectModel, toggleSparePart, toggleAllSpareParts, addImages, removeImage, setMainImage, setLocation, loadBrandsForCategory, loadModelsForBrand, loadSparePartsForCategory, loadCategorySchema, refreshBrands, generateDescription, submitAd, setUserHasInteracted, setLoadError, setFormError, setImageUploadError: imagesHook.setImageUploadError, setSubmittedAd, setValue, register, watch, initializeFromListing, resetToCreateMode }), [setCurrentStep, nextStep, prevStep, handleCategoryChange, handleBrandChange, createAndSelectBrand, createAndSelectModel, toggleSparePart, toggleAllSpareParts, addImages, removeImage, setMainImage, setLocation, loadBrandsForCategory, loadModelsForBrand, loadSparePartsForCategory, loadCategorySchema, refreshBrands, generateDescription, submitAd, setUserHasInteracted, setLoadError, setFormError, imagesHook.setImageUploadError, setSubmittedAd, setValue, register, watch, initializeFromListing, resetToCreateMode]);
