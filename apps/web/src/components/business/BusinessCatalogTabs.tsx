    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        <div
          ...
          className="flex items-center gap-1.5 p-1 bg-muted/50 rounded-2xl border border-border/70 overflow-x-auto scrollbar-none overscroll-x-contain flex-nowrap max-w-full touch-pan-x"
        >
          {tabs.map((tab) => {
