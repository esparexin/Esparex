...
export function BackendStatusBanner() {
    ...
    return (
        <div style={{ zIndex: Z_INDEX.backendStatusBanner }} /* design-token-ignore: canonical z-index token from @esparex/ui */ className="bg-yellow-100 text-yellow-800 text-body text-center py-2 px-4 shadow-sm border-b border-yellow-200 sticky top-0">
