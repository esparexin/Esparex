...
export function BottomActionsBar({ enabled = true }: { enabled?: boolean }) {
    ...
    return (
        <div className="fixed bottom-0 inset-x-0 z-50 bg-background border-t border-border px-4 pt-4 pb-[max(1rem,env(safe-area-inset-bottom))] md:hidden shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.1)]">
