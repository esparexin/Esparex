...
const ERROR_MESSAGES: Record<string, string> = {
    ...
    'OTP_DELIVERY_FAILED': 'Failed to deliver OTP via WhatsApp. Please try again.',
    'OTP_RESEND_COOLDOWN': 'Please wait before requesting another OTP.',
    'OTP_RESEND_LIMIT_REACHED': 'Maximum resend attempts reached. Please try again later.',
    'OTP_ALREADY_USED': 'This OTP has already been used. Please request a new code.',
    'OTP_PROVIDER_ERROR': 'OTP service temporarily unavailable. Please try again.',
    'OTP_VERIFICATION_FAILED': 'Unable to verify OTP at this time. Please try again.',
