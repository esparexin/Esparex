      ...
      <DialogContent className="max-w-md rounded-2xl p-0 overflow-hidden">
        ...
        <div className="p-6 space-y-4">
          ...
          <div>
            <label
              htmlFor={inputId}
              className="block text-tiny font-bold text-foreground-secondary mb-1.5 uppercase tracking-wider"
            >
            ...
            />
            {error && (
              <p id={errorId} role="alert" className="text-caption text-destructive mt-1">
                {error}
              </p>
            )}
            {minLength ? (
