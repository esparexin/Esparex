...
import { AlertTriangle, Box, Briefcase, CheckCircle, Edit, Filter, Loader2, Search, Smartphone, Trash2, Wrench as WrenchIcon, XCircle, Drone, Tv, Laptop, Tablet } from "lucide-react";
                ...
                <div className="absolute z-30 mt-2 w-full overflow-hidden rounded-lg border border-slate-200 bg-white shadow-lg">
                    <div className="border-b border-slate-100 p-2">
                        <input
                            ...
                            placeholder={placeholder}
                            className="w-full rounded-md border border-slate-200 px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-primary/20"
                            autoFocus
                        />
                    </div>
                    <div className="max-h-64 overflow-y-auto py-1" role="listbox">
                        ...
                        {options.length > visibleOptions.length ? (
                            <div className="border-t border-slate-100 px-3 py-2 text-xs text-slate-500">
                                Showing {visibleOptions.length} of {options.length}. Search to narrow results.
                            </div>
                        ) : null}
...
/**
 * Standardized icon getter for listing types and categories.
 */
export function getListingTypeIcon(type: string, size = 16) {
    ...
    switch (normalizedType) {
        ...
        case 'mobiles':
        case 'phone':
            return <Smartphone size={size} aria-hidden="true" focusable="false" />;
        case LISTING_TYPE.SERVICE:
        case 'service':
            return <Briefcase size={size} aria-hidden="true" focusable="false" />;
        case LISTING_TYPE.SPARE_PART:
        case 'spare_part':
            return <WrenchIcon size={size} aria-hidden="true" focusable="false" />;
        case 'drone':
        case 'drones':
            return <Drone size={size} aria-hidden="true" focusable="false" />;
        case 'laptop':
        case 'laptops':
            return <Laptop size={size} aria-hidden="true" focusable="false" />;
        case 'tablet':
        case 'tablets':
        case 'ipad':
            return <Tablet size={size} aria-hidden="true" focusable="false" />;
        case 'tv':
        case 'tvs':
        case 'led tv':
        case 'led tvs':
        case 'television':
        case 'monitor':
            return <Tv size={size} aria-hidden="true" focusable="false" />;
        default:
            return <Box size={size} aria-hidden="true" focusable="false" />;
    }
}
