...
export type OtpAuthEvent = "SEND_OTP" | "OTP_SENT" | "VERIFY_OTP" | "SUCCESS" | "FAIL" | "RESET" | "RESEND_OTP";
...
export const otpAuthMachine = createMachine<OtpAuthState, OtpAuthEvent>({
    ...
    states: {
        ...
        waitingForOtp: {
            on: { VERIFY_OTP: "verifyingOtp", SEND_OTP: "sendingOtp", RESET: "idle", RESEND_OTP: "sendingOtp" },
        },
        verifyingOtp: {
