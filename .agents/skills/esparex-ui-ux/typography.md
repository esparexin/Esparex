...
| `body-lg` | `1.0rem` (16px) | `1.5` | `0` | Lead text, page titles on mobile, minimum input size |
| `body` | `0.875rem` (14px) | `1.55` | `0` | Default body text, description text, nav/menu items |
