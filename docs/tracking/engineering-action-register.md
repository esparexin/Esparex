...
6. **Generous Spacing & Typography Hierarchy**: Increased vertical spacing (`space-y-4 sm:space-y-5`, `mb-5 sm:mb-6`) and aligned all font tokens to canonical `@esparex/design-tokens` SSOT (`text-h3`, `text-h2`, `text-body`, `text-body-lg`, `text-h4`).
