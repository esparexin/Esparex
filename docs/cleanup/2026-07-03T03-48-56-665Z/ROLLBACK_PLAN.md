...
```bash
git tag -a pre-cleanup-2026-07-03_03-48-56 -m "Pre-cleanup backup tag"
git push origin pre-cleanup-2026-07-03_03-48-56
```
...
```bash
git reset --hard pre-cleanup-2026-07-03_03-48-56
```
...
- [ ] In case of validation errors, immediately execute `git checkout pre-cleanup-2026-07-03_03-48-56 -- <failed-file>`.
