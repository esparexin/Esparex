...
- **Scan Time:** 2026-07-03T03:10:37.847Z
- **Workspace Count:** 5
...
Rollback commands have been generated using tag `pre-cleanup-2026-07-03_03-10-37`.
...
```bash
git tag -a pre-cleanup-2026-07-03_03-10-37 -m "Pre-cleanup backup tag"
git push origin pre-cleanup-2026-07-03_03-10-37
```
...
```bash
git reset --hard pre-cleanup-2026-07-03_03-10-37
```
...
- [ ] In case of validation errors, immediately execute `git checkout pre-cleanup-2026-07-03_03-10-37 -- <failed-file>`.
...
- **Rollback tag**: `pre-cleanup-2026-07-03_03-10-37`.
