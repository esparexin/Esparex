...
| **PERF-003** | Database Query | All profiled high-traffic queries used expected indexes (`IDHACK`, 1.2ms & `IN_LIST_FETCH`, 8.4ms); 0 `COLLSCAN` observed | Observed Measurement | **High** | [mongodb-explain-users-me.json](artifacts/mongodb-explain-users-me.json), [mongodb-explain-saved.json](artifacts/mongodb-explain-saved.json) |
