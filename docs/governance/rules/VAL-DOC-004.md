...
Case-Sensitive Filename Casing Detection

---

## Purpose

Ensures link targets match the exact case of filenames on disk.
...
Update link capitalization to match the file exactly.
