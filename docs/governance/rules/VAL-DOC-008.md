...
Document Lifecycle & Classification Validation

---

## Purpose

Checks metadata schema versions and lifecycle classifications.
...
Fill in the correct frontmatter tags for document lifecycle classification.
