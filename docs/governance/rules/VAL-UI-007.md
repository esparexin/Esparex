...
Design Token Usage / Hardcoded Colors

---

## Purpose

Detects hardcoded color strings in CSS/styled-components files.
...
Replace hardcoded hex/rgb/named colors with standardized design token variables.
