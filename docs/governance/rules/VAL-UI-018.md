...
Possible Unreachable Route

---

## Purpose

Detects Next.js page components with no matching Link or navigation references.
...
Verify if the route is intended to be public, and add link references if needed.
