...
Checks for raw modal implementations and enforces standard dialog wrap.
...
Use the shared Dialog or Modal components instead of direct HTML div dialog overlays.
