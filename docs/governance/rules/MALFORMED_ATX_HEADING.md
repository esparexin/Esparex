...
Detects ATX headings that do not have a space after the header characters (e.g. #Heading instead of # Heading).
...
Insert a space after the heading marker characters.
