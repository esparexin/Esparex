...
Table abstraction check

---

## Purpose

Enforces standard Table abstraction wrappers instead of raw HTML tables.
...
Use Table components from @mad/ui instead of raw <table> tags.
