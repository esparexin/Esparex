...
Enforces that only standard logger and observability wrappers are used, blocking raw console outputs.
...
Replace console.log/console.error with the standard Logger service calls.
