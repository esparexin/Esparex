...
Enforces standard accessibility properties (aria-labelledby, role="dialog") on modals.
...
Ensure the Modal/Dialog containers have appropriate role and aria attribute properties.
