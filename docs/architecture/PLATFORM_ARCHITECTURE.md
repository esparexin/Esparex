...
## Appendix A — Enterprise Platform State Coverage Matrix

*Previously maintained as `docs/architecture/state-coverage-matrix.md`. Consolidated here per DOCUMENTATION-GOVERNANCE §7 anti-sprawl policy.*
...
### Enterprise System State Matrix
