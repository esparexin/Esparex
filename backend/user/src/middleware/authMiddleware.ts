/**
 * ESPAREX — CANONICAL END-USER AUTH MIDDLEWARE
 *
 * Ownership transferred to backend/user gateway as part of
 * Milestone 3 Project A (Transport Separation — Batch 1).
 *
 * Previous SSOT: core/src/middleware/authMiddleware.ts
 * Current SSOT:  backend/user/src/middleware/authMiddleware.ts
 *
 * Used by:
 * - backend/user (Public App)
 * - backend/admin (Admin masked/masquerade actions) — still re-exports from here
 */
