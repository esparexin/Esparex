...
} from '@core/services/catalog/CatalogCategoryService';
...
import { clearCategoryCanonicalCache } from '@core/utils/categoryCanonical';
...
export const createCategory = async (req: Request, res: Response) => {
    try {
        ...
        } as Partial<import('@core/models/Category').ICategory>);
...
export const updateCategory = async (req: Request, res: Response) => {
    try {
        ...
        const updatedCategory = await CatalogOrchestrator.updateCategory(categoryId, payloadWithStatus as Partial<import('@core/models/Category').ICategory>);
