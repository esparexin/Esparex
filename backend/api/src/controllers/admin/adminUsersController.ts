...
export const getUserById = async (req: Request, res: Response) => {
    try {
        ...
        sendSuccessResponse(res, adminUsersService.normalizeAdminManagedUser(user as any));
    } catch (error: unknown) {
        sendAdminError(req, res, error);
    }
};
...
export const updateUserStatus = async (req: Request, res: Response) => {
    try {
        ...
        sendSuccessResponse(res, adminUsersService.normalizeAdminManagedUser(user as any), `User status updated to ${status}`);
    } catch (error: unknown) {
        sendAdminError(req, res, error);
    }
};
