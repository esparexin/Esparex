...
import { respond, sendSuccessResponse } from "@core/utils/respond";
import { handlePaginatedContent } from "@core/utils/contentHandler";
...
} from '@core/services/catalog/CatalogBrandModelService';
import { validateBrandIsActive, validateCategoryIsActive } from '@core/services/catalog/CatalogValidationService';
import { escapeRegExp } from '@core/utils/stringUtils';
import CatalogOrchestrator from '@core/services/catalog/CatalogOrchestrator';
import {
    sendCatalogError,
    QueryRecord,
...
import { validateBrandSuggestion, validateModelSuggestion } from '@core/utils/suggestionValidation';
import {
    brandCreateSchema,
    brandUpdateSchema,
    modelCreateSchema,
