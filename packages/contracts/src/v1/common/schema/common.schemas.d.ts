 ...
 */
export declare const trimString: (value: unknown) => unknown;
export declare const optionalTrimmedString: <T extends z.ZodTypeAny>(schema: T) => z.ZodEffects<z.ZodOptional<T>, T["_output"] | undefined, unknown>;
export declare const optionalTrimmedStringSchema: z.ZodEffects<z.ZodOptional<z.ZodString>, string | undefined, unknown>;
