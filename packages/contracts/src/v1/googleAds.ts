...
export const AD_PLACEMENT_LOCATION = {
    ...
    CATEGORY_HEADER: "category_page_header",
    CATEGORY_INLINE: "category_page_inline",
    LISTING_DETAILS_SIDEBAR: "listing_details_sidebar",
    LISTING_DETAILS_INCONTENT: "listing_details_incontent",
    SERVICES_HEADER: "services_page_header",
    SPARE_PARTS_HEADER: "spare_parts_header",
    BUSINESS_PROFILE_SIDEBAR: "business_profile_sidebar",
    USER_DASHBOARD_TOP: "user_dashboard_top",
    USER_MY_LISTINGS_INLINE: "user_my_listings_inline",
    BUSINESS_DASHBOARD_TOP: "business_dashboard_top",
    STATIC_PAGES_FOOTER: "static_pages_footer",
...
export const createGoogleAdPlacementSchema = z.object({
    ...
    location: z.enum([
        ...
        AD_PLACEMENT_LOCATION.CATEGORY_HEADER,
        AD_PLACEMENT_LOCATION.CATEGORY_INLINE,
        AD_PLACEMENT_LOCATION.LISTING_DETAILS_SIDEBAR,
        AD_PLACEMENT_LOCATION.LISTING_DETAILS_INCONTENT,
        AD_PLACEMENT_LOCATION.SERVICES_HEADER,
        AD_PLACEMENT_LOCATION.SPARE_PARTS_HEADER,
        AD_PLACEMENT_LOCATION.BUSINESS_PROFILE_SIDEBAR,
        AD_PLACEMENT_LOCATION.USER_DASHBOARD_TOP,
        AD_PLACEMENT_LOCATION.USER_MY_LISTINGS_INLINE,
        AD_PLACEMENT_LOCATION.BUSINESS_DASHBOARD_TOP,
        AD_PLACEMENT_LOCATION.STATIC_PAGES_FOOTER,
